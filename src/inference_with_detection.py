...
image_files = [os.path.join(keypoint_dataset, f) for f in os.listdir(keypoint_dataset) if f.endswith('.png')]
...
for f in image_files:
    ...
    person_results = [{'bbox': [749, 633, 1572, 2343, 0.98]}, {'bbox': [1828, 1509, 2628, 2469, 0.98]}]
