...
if __name__ == '__main__':
    ...
    opset_version = 11
    input_img = "data/inference/base/input/image_3-V211124-30fps-1_50-max10cm_00001.jpg"
    config = 'configs_mmdet/cascade_rcnn/cascade_rcnn_r50_fpn_1x_coco.py'
    checkpoint = "pretrained_weights/mmdet/cascade_rcnn_r50_fpn_1x_coco_20200316-3dc56deb.pth"
    input_shape = (1, 3, 960, 540)
    shape = [540, 960]
    # shape = None
    output_file = "mmdet_cascade_rcnn_r50_fpn_1x_coco.onnx"
    cfg_options = None
